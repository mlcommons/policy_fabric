# Policy Card — DUO_0000015 NMDS (No General Methods Research)
...
- **id:** `card.duo.0000015-nmds`
- **version:** 1.0.0
- **status:** released
- **title:** No General Methods Research (DUO_0000015 NMDS)
- **description:** Grant access only when a project's intended-use approval is not
  a methods-development, AI or software-development, or model-training purpose, and
  the requester is bound to that project as a member of the owning PI's team.
- **author:** MLCommons
- **contact:** —
...
|---------|------------|-------------------------------|----------|--------------------------------------------------------|
| 1.0.0   | 2026-07-15 | MLCommons                     | released | Initial policy card authored from the NMDS policy.     |

## 4  Summary & Intent

Access to the dataset is closed to general methods research. A project's
`IntendedDataUseCredential` declares the purposes the project is approved to
pursue; access is granted only when none of those purposes is in the
...
- **Governance objective:** restrict download of the asset to projects whose
  approved intended use is not a methods-development, AI or software-development,
  or model-training purpose.
