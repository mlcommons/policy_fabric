# Unit tests for DUO_0000015 (NMDS).  Run with:  opa test nmds/ -v
package subpolicy_test

import data.subpolicy

base_input := {
	"policy_data": {"prohibitedPurposes": ["MDS", "AI_Development", "Software_Development", "TrainModel"]},
	"presentations": {"User": [
		{
...
test_allow_when_no_prohibited_purpose if {
