...
#
# Allow when a project's IntendedDataUseCredential limits use to a disease within
# the data owner's allowed MONDO scope, and the requester is bound to that project
...
# allowed disease codes are configured by the data owner in policy_data. That key is
