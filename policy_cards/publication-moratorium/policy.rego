...
# attests it handles results securely -- the attestation that lets the publication
# moratorium be honoured. An AgreementCredential whose claim
...
# a secure compute environment must be attested for the moratorium to be enforceable
