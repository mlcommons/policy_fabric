# Policy Card — DUO_0000016 GSO (Genetic Studies Only)
...
- **id:** `card.duo.0000016-gso`
- **version:** 1.0.0
- **status:** released
- **title:** Genetic Studies Only (DUO_0000016 GSO)
- **description:** Grant access only when a project's intended-use approval is a
  permitted genetic or genotype study purpose, and the requester is bound to that
...
|---------|------------|-------------------------------|----------|--------------------------------------------------------|
| 1.0.0   | 2026-07-15 | MLCommons                     | released | Initial policy card authored from the GSO policy.      |

## 4  Summary & Intent

Access to the dataset is limited to genetic and genotype studies. A project's
`IntendedDataUseCredential` declares the purposes the project is approved to
pursue; access is granted only when at least one of those purposes is in the
`allowedPurposes` set the data owner configured. The requester is tied to the
...
- **Governance objective:** restrict download of the asset to projects whose
  approved intended use is a permitted genetic or genotype study purpose.
