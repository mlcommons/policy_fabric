...
#
# Allow when a project's IntendedDataUseCredential declares a purpose that falls
...
# public key. The allowed research purposes are configured by the data owner in
...
# intended-data-use credentials whose purposes fall within the allowed research scope
matching_idu := [c |
	some c in idu_creds
