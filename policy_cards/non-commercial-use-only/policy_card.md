# Policy Card — DUO_0000046 NCU (Non-Commercial Use Only)
...
- **id:** `card.duo.0000046-ncu`
- **version:** 1.0.0
- **status:** released
- **title:** Non-Commercial Use Only (DUO_0000046 NCU)
- **description:** Grant access only when a project's intended-use approval is not
  a commercial purpose, and the requester is bound to that project as a member of
  the owning PI's team.
- **author:** MLCommons
- **contact:** —
...
|---------|------------|-------------------------------|----------|--------------------------------------------------------|
| 1.0.0   | 2026-07-15 | MLCommons                     | released | Initial policy card authored from the NCU policy.      |

## 4  Summary & Intent

Access to the dataset is limited to non-commercial use. A project's
...
- **Governance objective:** restrict download of the asset to projects whose
  approved intended use is not a commercial purpose.
